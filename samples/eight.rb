...
words = Eight.break_words(sentence)
sorted_words = Eight.sort_words(words)

Eight.puts_first_word(words)
Eight.puts_last_word(words)
Eight.puts_first_word(sorted_words)
Eight.puts_last_word(sorted_words)
sorted_words = Eight.sort_sentence(sentence)
print sorted_words

Eight.puts_first_and_last(sentence)

Eight.puts_first_and_last_sorted(sentence)
